...
@Entity
@Table(name = "formulation_cost_base_domestic", schema = "iocl")
public class PoCompetitors {
	@Id
	@SequenceGenerator(name = "PoCompetitorseq", sequenceName = "iocl.formulation_cost_base_domestic_seq", allocationSize = 1)
